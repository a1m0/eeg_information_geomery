...
#### واگرایی Jensen-Shannon Divergence (JSD)
واگرایی JSD تصحیح متقارن از KL divergence است:
...
#### واگرایی کولبک-لیبلر (Kullback-Leibler (KL) Divergence)
واگرایی کولبک-لیبلر معیاری برای اینکه یک توزیع $Q$ چقدر از توزیع واقعی $P$ فاصله دارد:
